...
const TeacherViewExams = () => {
  const navigate = useNavigate();

  const cards = [
    { label: 'First Term', icon: <FaRegListAlt size={32} />, path: '/view-first' },
    { label: 'Second Term', icon: <FaCalendarWeek size={32} />, path: '/view-second' },
    { label: 'Third Term', icon: <FaDatabase size={32} />, path: '/view-third' },
  ];

  return (
    <TeacherLayout>
    <Box sx={{ p: 4, maxWidth: 1000, mx: 'auto', backgroundColor: 'white', borderRadius: 3 }}>
...
export default TeacherViewExams;
